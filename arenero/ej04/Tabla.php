<?php
    class Tabla{
        ...
        //Cuando utilizamos un metodo de una clase dentro de la misma clase usamos el this
        public function graficar(){
            $this->inicio_tabla();
            for ($i=0; $i < $this->numFilas ; $i++) {//Recorre filas
                $this->inicio_fila();
                for($j=0; $j < $this->numColumnas ; $j++){//Recorre columnas
