        ...
        <html>
            ...
            <body>
                <div class="container-fluid d-flex justify-content-between align-items-center">
                    <div><img class="rounded" src="Netflix_logo.png" alt="Logo"  width="130px" height="80px"/></div>
                    <div><h1>Catálogo VOD</h1></div>
                </div>
                <h2 class="display-6">Perfil de Usuario</h2>
                <xsl:for-each select="/CatalogoVOD/cuenta/perfiles/perfil">
                    <p class="h5"><strong>Usuario:</strong> <xsl:value-of select="@usuario" /><br/>
                       <strong>Idioma:</strong> <xsl:value-of select="@idioma" /></p>
                </xsl:for-each>
